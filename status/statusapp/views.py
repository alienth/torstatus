...
def current_results_csv(request):
    ...
    currentColumns = []
    if not ('currentColumns' in request.session):
        currentColumns = ["Country Code", "Uptime", "ORPort", "DirPort", "IP", \
                    "Exit", "Authority", "Fast", "Guard", "Stable", \
                    "Bandwidth", "V2Dir", "Platform", "BadExit", "Named"]
        request.session['currentColumns'] = currentColumns
    else:
        currentColumns = request.session['currentColumns']
...
=======
    return render_to_response('statisticgraphs.html')
>>>>>>> 92d7eb7172aed7fe47acc65c5bc7575623d841bf
