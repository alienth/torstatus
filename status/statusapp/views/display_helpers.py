...
SEARCH_OPTIONS_FIELDS_BOOLEANS = {
        'Fingerprint': ['Equals', 'Contains', 'Starts With',],
        'Router Name': ['Equals (case insensitive)', 'Equals (case sensitive)',
                    'Contains', 'Starts With',],
        'Country Code': ['Equals (case insensitive)',],
        'Bandwidth (kb/s)': ['Equals', 'Is Less Than', 'Is Greater Than',],
        'Uptime (days)': ['Equals', 'Is Less Than', 'Is Greater Than',],
        'Last Descriptor Published': ['Equals', 'Is Less Than', 
                    'Is Greater Than',],
        'IP Address': ['Equals', 'Starts With',],
        'Onion Router Port': ['Equals', 'Is Less Than', 'Is Greater Than',],
        'Directory Server Port': ['Equals', 'Is Less Than', 'Is Greater Than',],
